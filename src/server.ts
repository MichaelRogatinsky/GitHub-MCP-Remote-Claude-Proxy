...
export function createServer() {
        ...
        "create_or_update_file",
        {
            ...
            inputSchema: {
                ...
                content: z
                    .string()
                    .describe(
                        "The new file content (plain text, will be base64-encoded automatically)",
                    ),
    ...
    server.registerTool(
                ...
                edits: z
                    .array(
                        z.object({
                            old_text: z
                                .string()
                                .describe("Exact text to find in the file"),
                            new_text: z
                                .string()
                    ...
                    .min(1)
                    .describe(
                        "List of search-and-replace edits to apply in order",
                    ),
                message: z.string().describe("Commit message"),
                branch: z
                    .string()
        ...
        async ({ owner, repo, path, edits, message, branch }) => {
            ...
            let content = Buffer.from(existing.content, "base64").toString(
                "utf-8",
            );
